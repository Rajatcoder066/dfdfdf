...
import { ScienceHard } from '../src/ScienceHard';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(ScienceHard);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Science Questions :{' ' + currentIndex + '/' + ScienceHard.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
      ...
      <View
        ...
        {currentIndex == ScienceHard.length ? (
          <TouchableOpacity
            style={{
