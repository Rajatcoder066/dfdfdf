...
import { SciencData } from '../src/Sciencebasic';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(SciencData);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Science Questions :{' ' + currentIndex + '/' + SciencData.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
      ...
      <View
        ...
        {currentIndex == SciencData.length ? (
          <TouchableOpacity
            style={{
