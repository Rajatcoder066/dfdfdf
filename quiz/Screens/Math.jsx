...
import { MathBasic } from '../src/MathBasic';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(MathBasic);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Math Questions :{' ' + currentIndex + '/' + MathBasic.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
