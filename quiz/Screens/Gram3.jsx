...
import { Grammar3 } from '../src/Grammar3';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(Grammar3);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Grammar Questions :{' ' + currentIndex + '/' + Grammar3.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
