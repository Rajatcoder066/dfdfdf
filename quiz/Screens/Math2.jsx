...
import { MathHard } from '../src/MathHard';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(MathHard);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Math Questions :{' ' + currentIndex + '/' + MathHard.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
