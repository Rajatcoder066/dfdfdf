...
import { ScienceMedium } from '../src/ScienceMedium';
...
const HomeScreen1 = (props) => {
  ...
  const [questions, setQuestions] = useState(ScienceMedium);
...
console.log(ScienceMedium.length);
     ...
     style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Science Questions :{'  ' + currentIndex + '/' + ScienceMedium.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
      ...
      <View
        ...
        {currentIndex == ScienceMedium.length ? (
          <TouchableOpacity
            style={{
