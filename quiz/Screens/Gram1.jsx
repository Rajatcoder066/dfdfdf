...
import { Grammar1 } from '../src/Grammar1';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(Grammar1);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Grammar Questions :{' ' + currentIndex + '/' + Grammar1.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
