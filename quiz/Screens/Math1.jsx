...
import { MathMedium } from '../src/MathMedium';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(MathMedium);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
         ...
         Math Questions :{' ' + currentIndex + '/' + MathMedium.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
      ...
      <View
        ...
        {currentIndex == MathMedium.length ? (
          <TouchableOpacity
            style={{
