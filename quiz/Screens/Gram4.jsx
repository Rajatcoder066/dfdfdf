...
import { Grammar4 } from '../src/Grammar4';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(Grammar4);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Grammar Questions :{' ' + currentIndex + '/' + Grammar4.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
