...
import { Grambasic } from '../src/Grambasic';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(Grambasic);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Grammar Questions :{' ' + currentIndex + '/' + Grambasic.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
