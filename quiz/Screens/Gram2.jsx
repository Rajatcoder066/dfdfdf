...
import { Grammar2 } from '../src/Grammar2';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(Grammar2);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Grammar Questions :{' ' + currentIndex + '/' + Grammar2.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
