...
import {Apitiude3} from '../src/Arithmatic3';
...
const HomeScreen = (props) => {
  ...
  const [questions, setQuestions] = useState(Apitiude3);
    ...
    style={styles.image}>
      ...
      <View
        ...
        <Text
          ...
          Aptitude Questions :{' ' + currentIndex + '/' + Apitiude3.length}
        </Text>
        <Text
          style={{
            marginRight: 20,
